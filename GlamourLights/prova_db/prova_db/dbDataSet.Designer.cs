...
namespace prova_db {
    ...
    public partial class dbDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(int OrderID, int CustomerID, System.DateTime Date) {
            ...
            public System.DateTime Date {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Il valore della colonna \'Date\' nella tabella \'Orders\' è DBNull.", e);
                    }
                }
                set {
...
namespace prova_db.dbDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Orders] WHERE (([OrderID] = @Original_OrderID) AND ([CustomerI" +
                "D] = @Original_CustomerID) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date]" +
                " = @Original_Date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([OrderID], [CustomerID], [Date]) VALUES (@OrderID, @C" +
                "ustomerID, @Date);\r\nSELECT OrderID, CustomerID, Date FROM Orders WHERE (OrderID " +
                "= @OrderID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Orders] SET [OrderID] = @OrderID, [CustomerID] = @CustomerID, [Date] = @Date WHERE (([OrderID] = @Original_OrderID) AND ([CustomerID] = @Original_CustomerID) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT OrderID, CustomerID, Date FROM Orders WHERE (OrderID = @OrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::prova_db.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Delete(int Original_OrderID, int Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(int OrderID, int CustomerID, global::System.Nullable<global::System.DateTime> Date) {
        ...
        public virtual int Update(int OrderID, int CustomerID, global::System.Nullable<global::System.DateTime> Date, int Original_OrderID, int Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CustomerID, global::System.Nullable<global::System.DateTime> Date, int Original_OrderID, int Original_CustomerID, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Original_OrderID, CustomerID, Date, Original_OrderID, Original_CustomerID, Original_Date);
        }
    }
