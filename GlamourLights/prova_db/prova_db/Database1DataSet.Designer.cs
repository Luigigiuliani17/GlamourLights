...
namespace prova_db {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(int CustomerID, string ContactName) {
...
namespace prova_db.Database1DataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerID], [ContactName]) VALUES (@CustomerID, " +
                "@ContactName);\r\nSELECT CustomerID, ContactName FROM Customers WHERE (CustomerID " +
                "= @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [ContactName] = @ContactName WHERE (([CustomerID] = @Original_CustomerID) AND ([ContactName] = @Original_ContactName));
SELECT CustomerID, ContactName FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, ContactName FROM dbo.Customers";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT CustomerID, ContactName FROM dbo.Customers";
        ...
        public virtual Database1DataSet.CustomersDataTable GetCustomersQuery() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Database1DataSet.CustomersDataTable dataTable = new Database1DataSet.CustomersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(int Original_CustomerID, string Original_ContactName) {
        ...
        public virtual int Insert(int CustomerID, string ContactName) {
        ...
        public virtual int Update(int CustomerID, string ContactName, int Original_CustomerID, string Original_ContactName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ContactName, int Original_CustomerID, string Original_ContactName) {
            return this.Update(Original_CustomerID, ContactName, Original_CustomerID, Original_ContactName);
        }
    }
